...
const Strategy = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-[url('/Images/Banner/2.png')] max-w-screen h-fit bg-cover">
      ...
      <div className="w-full bg-black">
        <div className="text-white flex flex-col justify-center items-center w-full max-w-[1200px] mx-auto">
          <h1 className="text-subheading font-bold">STRUCTURE FABRICATION PROCESS FLOW</h1>
